...
def read_input(exel_name):
    ...
    for i in range(len(days)):
        days[i] = Day(*days[i])
    days.clear()#عملت كلير هنا عشان احط ايام من الجدول تحت ابقى شيلها بعد التعديل
    return True
...
exam_day_input = [
    ExamDay(1, "12/11/2020", ["e3dady", "1st etisalat"]),
    ExamDay(2, "14/10/2020", ["e3dady", "1st etisalat"]),
]
collage_day_input = [
    collageDay(
        {
            "e3dady": [Hall(0, 1, 1, 75, "sb4-1"), Hall(0, 2, 2, 55, "sb7-1")],
            "1st etisalat": [Hall(0, 1, 1, 25, "sb4-1"), Hall(0, 2, 2, 55, "sb7-1")],
        }
    ),
    collageDay(
        {
            "e3dady": [Hall(0, 1, 1, 25, "sb4-1"), Hall(0, 2, 2, 55, "sb7-1")],
            "1st etisalat": [Hall(1, 1, 1, 25, "sb4-1"), Hall(1, 2, 2, 55, "sb7-1")],
        }
    ),
]
...
ok = process_exam_day(exam_day_input,collage_day_input)
for i in days:
