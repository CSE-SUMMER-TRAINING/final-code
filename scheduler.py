...
class invScreen2(QWidget):
    ...
    def msg2(self):
        if unvalid_emails:
            try:
                QMessageBox.about(self, "تحذير", "لاتغلق ملف الإكسيل الذي سيظهر الآن قبل ظهور رسالة التأكيد<br>فقد يلحق الضرر بالعملية التي تجريها الآن أو يؤدي إلى نتائج غير مرغوب فبها.")
